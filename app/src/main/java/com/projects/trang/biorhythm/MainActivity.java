            ...
            public void onClick(View v) {
                if (tvBirthday.getText().equals("") || tvSelectedDate.getText().equals("")) {
                    ...
                    if(item.equals("the selected day")){
                        ...
                        Log.d(TAG, "*****birth date: " + aCalculator.getStart_date());
                        BarChartRender aBarChart = new BarChartRender(barChart,(int) (100 * aCalculator.getPhysicalValue()),(int) (100 * aCalculator.getEmotionalValue()),(int) (100 * aCalculator.getIntellectualValue()));

                        aBarChart.drawBarChart();
                        tvPhysical.setText(String.format("Physical: %s%%", (int) (100 * aCalculator.getPhysicalValue())));
                        tvPhysical.setTextColor(Color.rgb(204,51,102));
                        tvEmotional.setText(String.format("Emotion: %s%%", (int) (100 * aCalculator.getEmotionalValue())));
                        tvEmotional.setTextColor(Color.rgb(255,69,0));
                        tvIntellectual.setText(String.format("Inteligence: %s%%", (int) (100 * aCalculator.getIntellectualValue())));
